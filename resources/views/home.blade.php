...
<section style="padding: 60px 0 80px; position: relative;">
    <div class="container" style="text-align: center;">
        ...
        <div class="glass-panel" style="max-width: 780px; margin: 0 auto 50px; padding: 12px; box-shadow: 0 10px 40px rgba(0,0,0,0.6);">
            <form id="domainSearchForm" onsubmit="searchDomain(event)" style="display: flex; gap: 10px; flex-wrap: wrap;">
                <div style="flex: 1; min-width: 260px; position: relative;">
                    <input type="text" id="domainInput" placeholder="Search your AI domain (e.g. neuroflow.ai, deepmind.cloud)" style="width: 100%; height: 52px; font-size: 16px; padding-left: 20px; border-radius: 12px; background: rgba(8, 12, 22, 0.95); border: 1px solid rgba(255,255,255,0.15);" required>
                </div>
            ...
            <div style="display: flex; justify-content: center; gap: 12px; margin-top: 14px; flex-wrap: wrap;">
                @foreach($domainPlans->take(5) as $plan)
                    <div style="font-size: 12px; color: var(--text-muted); background: rgba(255,255,255,0.03); padding: 4px 12px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.06); cursor: pointer;" onclick="document.getElementById('domainInput').value = 'mybrand{{ $plan->specs['tld'] ?? '.ai' }}'; searchDomain(event);">
                        <strong style="color: #ffffff;">{{ $plan->specs['tld'] ?? '.com' }}</strong> ${{ number_format($plan->price_monthly, 2) }}/yr
                    </div>
                @endforeach
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px; max-width: 1000px; margin: 0 auto;">
            <div class="glass-panel" style="padding: 24px; text-align: left;">
                ...
                <div style="font-weight: 700; color: #ffffff; font-size: 16px;">Google Cloud Core</div>
                <div style="color: var(--text-muted); font-size: 13px;">Compute Engine VMs with direct peering and global VPC networks.</div>
            </div>
            <div class="glass-panel" style="padding: 24px; text-align: left;">
                <div style="color: var(--primary-light); font-size: 24px; margin-bottom: 8px;">⚙️</div>
                <div style="font-weight: 700; color: #ffffff; font-size: 16px;">CWP Control Panel</div>
            ...
            <div class="glass-panel" style="padding: 24px; text-align: left;">
                ...
                <div style="font-weight: 700; color: #ffffff; font-size: 16px;">InternetBS Reseller API</div>
            ...
            <div class="glass-panel" style="padding: 24px; text-align: left;">
                ...
                <div style="font-weight: 700; color: #ffffff; font-size: 16px;">Google Cloud Run Ready</div>
...
<section id="pricing" style="padding: 80px 0; border-top: 1px solid rgba(255,255,255,0.06);">
    <div class="container">
        <div style="text-align: center; margin-bottom: 50px;">
            ...
            <div style="display: inline-flex; align-items: center; gap: 12px; background: rgba(16, 24, 40, 0.8); padding: 6px; border-radius: 30px; border: 1px solid rgba(255,255,255,0.1); margin-top: 28px;">
        ...
        <div style="margin-bottom: 60px;">
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px;">
                <div>
                    <h3 style="font-size: 22px; font-weight: 700; color: #ffffff;">1. Shared Hosting on CWP</h3>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px;">
                @foreach($hostingPlans as $plan)
                    <div class="glass-panel" style="padding: 32px; position: relative; {{ ($plan->specs['popular'] ?? false) ? 'border-color: var(--primary-light); box-shadow: var(--glow-primary);' : '' }}">
                        ...
                        <div style="font-size: 18px; font-weight: 700; color: #fff; margin-bottom: 6px;">{{ $plan->name }}</div>
        ...
        <div>
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px;">
                <div>
                    <h3 style="font-size: 22px; font-weight: 700; color: #ffffff;">2. Dedicated Google Cloud VM with CWP</h3>
                    ...
                    <div class="glass-panel" style="padding: 32px; position: relative;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 12px;">
                            <div>
                                ...
                                <h4 style="font-size: 20px; font-weight: 700; color: #fff;">{{ $plan->name }}</h4>
                            </div>
                            <div style="background: rgba(6, 182, 212, 0.1); border: 1px solid rgba(6, 182, 212, 0.3); color: var(--accent-cyan); padding: 4px 8px; border-radius: 6px; font-size: 11px; font-weight: 700;">
                        ...
                        <div style="background: rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.06); border-radius: 10px; padding: 14px; margin-bottom: 20px; display: grid; grid-template-columns: 1fr 1fr; gap: 8px; font-size: 13px;">
...
<section style="padding: 80px 0; background: rgba(11, 16, 30, 0.4); border-top: 1px solid rgba(255,255,255,0.06);">
    <div class="container">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: center;">
            <div>
                <div class="badge-ai" style="margin-bottom: 16px;">Zero Complexity Panel</div>
                <h2 style="font-size: clamp(28px, 3.5vw, 40px); font-weight: 800; margin-bottom: 20px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 16px; margin-bottom: 30px;">
                    <div style="display: flex; gap: 14px; align-items: flex-start;">
                        <div style="background: rgba(99, 102, 241, 0.15); color: var(--primary-light); width: 32px; height: 32px; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-weight: bold;">1</div>
                        <div>
                            <strong style="color: #ffffff;">Instant Account Creation:</strong>
                    ...
                    <div style="display: flex; gap: 14px; align-items: flex-start;">
                        <div style="background: rgba(6, 182, 212, 0.15); color: var(--accent-cyan); width: 32px; height: 32px; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-weight: bold;">2</div>
                        <div>
                            <strong style="color: #ffffff;">Single Sign-On (SSO):</strong>
                    ...
                    <div style="display: flex; gap: 14px; align-items: flex-start;">
                        <div style="background: rgba(168, 85, 247, 0.15); color: var(--accent-purple); width: 32px; height: 32px; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-weight: bold;">3</div>
                        <div>
                            <strong style="color: #ffffff;">Google Cloud Reliability:</strong>
            ...
            <div class="glass-panel" style="padding: 24px; background: #070a14; border: 1px solid rgba(99, 102, 241, 0.25); box-shadow: 0 20px 50px rgba(0,0,0,0.8);">
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px; border-bottom: 1px solid rgba(255,255,255,0.08); padding-bottom: 12px;">
                    ...
                    <span style="font-size: 12px; color: var(--text-muted); font-family: monospace;">cwp-provisioning-stream.log</span>
                </div>
                <div style="font-family: monospace; font-size: 13px; line-height: 1.7; color: #93c5fd;">
                    ...
                    <p style="color: var(--text-muted);">[22:30:12] Contacting CWP Node at https://srv.shamsman.com:2031/api/ ...</p>
...
<section style="padding: 80px 0;">
    <div class="container" style="max-width: 860px;">
        <div style="text-align: center; margin-bottom: 48px;">
            ...
            <h2 style="font-size: 36px; font-weight: 800;">Frequently Asked Questions</h2>
        </div>

        <div style="display: flex; flex-direction: column; gap: 16px;">
            <div class="glass-panel" style="padding: 24px;">
                <h4 style="font-size: 17px; font-weight: 700; color: #fff; margin-bottom: 8px;">How does domain registration work with InternetBS?</h4>
            ...
            <div class="glass-panel" style="padding: 24px;">
                <h4 style="font-size: 17px; font-weight: 700; color: #fff; margin-bottom: 8px;">Where is the CWP control panel located?</h4>
                <p style="color: var(--text-muted); font-size: 14px; line-height: 1.6;">
            ...
            <div class="glass-panel" style="padding: 24px;">
                <h4 style="font-size: 17px; font-weight: 700; color: #fff; margin-bottom: 8px;">Can I get a custom Google Cloud VM with CWP pre-installed?</h4>
                <p style="color: var(--text-muted); font-size: 14px; line-height: 1.6;">
            ...
            <div class="glass-panel" style="padding: 24px;">
                <h4 style="font-size: 17px; font-weight: 700; color: #fff; margin-bottom: 8px;">How are live database migrations performed?</h4>
                <p style="color: var(--text-muted); font-size: 14px; line-height: 1.6;">
    ...
    async function searchDomain(e) {
        ...
        try {
            ...
            if (data.available) {
                ...
                box.innerHTML = `
                    <div>
                        <div style="font-weight: 700; color: #34d399; font-size: 16px;">✓ <strong>${data.domain}</strong> is available!</div>
                    ...
                    <div style="display: flex; align-items: center; gap: 16px;">
                        <span style="font-size: 22px; font-weight: 800; color: #ffffff;">$${parseFloat(data.price).toFixed(2)}<span style="font-size: 13px; color: var(--text-muted);">/yr</span></span>
                ...
                box.innerHTML = `
                    <div>
                        <div style="font-weight: 700; color: #f87171; font-size: 16px;">✗ <strong>${data.domain}</strong> is already taken.</div>
            ...
            box.innerHTML = `<div style="color: #f87171;">Failed to connect to domain availability service. Please try again.</div>`;
        } finally {
