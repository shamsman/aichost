...
<div class="container" style="padding-top: 32px; padding-bottom: 80px;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; flex-wrap: wrap; gap: 16px;">
        <div>
            <h1 style="font-size: 28px; font-weight: 800; color: #fff;">My Registered Domains</h1>
    ...
    @if($domains->isEmpty())
        <div class="glass-panel" style="padding: 60px; text-align: center;">
            ...
            <h3 style="font-size: 18px; margin-bottom: 8px;">No domains registered yet</h3>
                    ...
                    @foreach($domains as $dom)
                        <tr style="border-bottom: 1px solid rgba(255,255,255,0.04);">
                            <td style="padding: 16px;">
                                <strong style="color: #ffffff; font-size: 15px;">{{ $dom->domain_name }}</strong>
                            </td>
                            <td style="padding: 16px; color: var(--text-muted);">
                                InternetBS API
                            </td>
                            <td style="padding: 16px; font-family: monospace; font-size: 12px; color: var(--accent-cyan);">
